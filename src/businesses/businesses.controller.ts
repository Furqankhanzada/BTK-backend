...
export class BusinessesController {
  ...
  createFavorite(@Param('id') id: string, @Request() req): Promise<Business> {
    ...
    return this.businessesService.createFavorite(id, currentUserID);
  }

  @Delete('/:id/favorite')
  @UseGuards(JwtAuthGuard)
  removeFavorite(@Param('id') id: string, @Request() req): Promise<any> {
    const { _id: currentUserID } = req.user;
    return this.businessesService.removeFavorite(id, currentUserID);
  }
}
